	  ...
	  <div class="container-fuild">
	  	<?php
	  		if ($_GET['bsub'] == 'SUBMIT DATA'){
	  			...
	  			$bauth = $_GET['bauthor'];
	  			$bprice = $_GET['bprice'];
	  			$inbook = "INSERT INTO u_books VALUES ('$UEmail','$bname','$bauth','$bprice')";
	  			if ($conn->query($inbook) === TRUE) {
		?>
				<br><h4><u>BOOK DETAILS</u></h4><br>
				<br><h4>BOOK NAME: &nbsp&nbsp <?php echo "$bname" ?> </h4><br>
				<br><h4>BOOK AUTHOR:&nbsp&nbsp <?php echo "$bauth" ?> </h4><br>
				<br><h4>BOOK PRICE: &nbsp&nbsp<?php echo "$bprice" ?> </h4><br>
				<br><h4>The Book is inserted!</h4><br>
		<?php
				header("Refresh: 5,url= dashboard.php");
				} else {
				    echo "<br><h4>Oops....Something went Wrong!</h4><br>";
