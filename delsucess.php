	  ...
	  <div class="container-fuild">
	  	<?php
	  		if (isset($_GET['delsub'])){
	  			...
	  			session_start();
	  			extract($_GET);
	  			$delquery = "DELETE FROM u_books WHERE BName = '$bname' AND UEmail = '".$_SESSION['UEmail']."'";
	  			if (mysqli_query($conn,$delquery)) {
	  				echo "<h4>Book named $bname is deleted successfully!</h4><br><br>";
	  				header("Refresh: 5,url= dashboard.php");
	  			}
	  			else{
	  				echo "<h4>Oops...Something went wrong.</h4><br><br><h4>Book is not deleted!</h4>";
	  				echo "<br><br><h4>Now redirecting you to Dashboard......";
	  				header("Refresh: 5,url= dashboard.php");	
	  			}
	  		}
	  	?>
